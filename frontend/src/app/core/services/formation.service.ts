...
export class FormationService {
  ...
  filterByMaxPrice(prixMax: number): Observable<Formation[]> {
    const params = new HttpParams().set('prixMax', prixMax.toString());
    return this.http.get<Formation[]>(`${this.apiUrl}/by-max-price`, { params });
  }
  ...
  activate(id: number): Observable<Formation> {
    return this.http.put<Formation>(`${this.apiUrl}/activate/${id}`, {});
  }
}
